...
logging.basicConfig(level=logging.INFO, filename='log_info_weather_api.log', filemode='w')
...
class Weather:
    ...
    def get_loc_key_by_city(self, name):
        ...
        if r.status_code == 200 and r.json():
            ...
            coordinates = {'lat': r.json()[0]['GeoPosition']['Latitude'], 'lon': r.json()[0]['GeoPosition']['Longitude']}
